...
function App() {
  ...
  if (page === "managestock") return <Managestock setPage={setPage} stockList={stockList} setStockList={setStockList} stock={stock} setStock={setStock} updateStock={updateStock} deleteStock={deleteStock} jsonToExcel={jsonToExcel} />
}
